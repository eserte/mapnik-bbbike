...
parser.add_argument('--mapfile', default="bbbike",
                    help='map file, specify without .xml extension (default: bbbike, other possibilities: bbbike-smoothness, bbbike-smoothness-solid, bbbike-handicap, bbbike-green, bbbike-unlit, bbbike-cycleway, bbbike-cycles-routes)')
